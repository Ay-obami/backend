...
export class NotificationService {
  constructor(@Inject(LogEmailProvider) private readonly provider: EmailProvider) {}

  sendTicketReceipt(input: { to: string; buyerName: string; eventName: string; ticketType: string; seat: string }): Promise<void> {
